...
import lombok.Data;
 ...
 - frequency - in days, required
 - repeats - if not specified the app will keep reminding unless suspend or delete the action
 - noticePeriod (advance and short are optional. the reminder will take place on the actual day in the morning anyway)
 ...
 for DONE -> the status of the event will be DONE, the start date and frequency not affected
 for SKIP -> the status for the event will be SKIPPED, the start date and frequency not affected
...
public class Action {
    ...
    private int frequency; //in days, required
    private Integer repeats;
    private int noticePeriodAdvance; //in days, not required
    private int noticePeriodShort; //in days, not required
