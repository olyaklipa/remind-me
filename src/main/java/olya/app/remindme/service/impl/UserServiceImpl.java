...
public class UserServiceImpl implements UserService {
    ...
    public User add(UserRequestDto userRequestDto) {
        ...
        // passwordService for repeatPassword validation and encryption?
        user.setPassword(validateRepeatPassword(userRequestDto.getPassword(), userRequestDto.getRepeatPassword()));
